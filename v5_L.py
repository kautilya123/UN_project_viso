...
model = torch.hub.load('ultralytics/yolov5', 'yolov5l')  # Change to 'yolov5m'

# Open the video file or webcam stream
video_path = 'input_video_chair3.mp4'  # Replace with your video file or 0 for webcam
...
output_video_path = 'output_with_detections_yolov5m.mp4'  # Change to desired path
