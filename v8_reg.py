...
# Load the YOLOv8 model (nano variant here, you can use 'yolov8n.pt', 'yolov8s.pt', etc.)
...
while True:
    ...
    # Apply YOLOv8 model to each frame
    for i, frame in enumerate(frames):
        ...
        cv2.imshow(f'YOLOv8 Video {i+1}', result_frame_writable)
